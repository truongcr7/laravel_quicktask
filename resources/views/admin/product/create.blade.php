        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-add" action="{{ route('product.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control" id="inputPrice" placeholder="Enter price" aria-invalid="false">
                                @error('price')
                                    <small class="help-block" style="color: red;">{{ $message }}</small>
                                @enderror
                            </div>
